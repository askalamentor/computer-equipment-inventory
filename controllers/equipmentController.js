...
exports.equipment_detail_list = asyncHandler(async (req, res, next) => {
...
exports.equipment_detail_create_get = asyncHandler(async (req, res, next) => {
  res.send('NOT IMPLEMENTED: Equipment create GET');
});

// Handle Equipment create on POST.
exports.equipment_detail_create_post = asyncHandler(async (req, res, next) => {
  res.send('NOT IMPLEMENTED: Equipment create POST');
});

// Display Equipment delete form on GET
exports.equipment_detail_delete_get = asyncHandler(async (req, res, next) => {
  res.send('NOT IMPLEMENTED: Equipment delete GET');
});

// Handle Equipment delete on POST
exports.equipment_detail_delete_post = asyncHandler(async (req, res, next) => {
  res.send('NOT IMPLEMENTED: Equipment delete POST');
});

// Display Equipment update form on GET
exports.equipment_detail_update_get = asyncHandler(async (req, res, next) => {
  res.send('NOT IMPLEMENTED: Equipment update GET');
});

// Handle Equipment update on POST
exports.equipment_detail_update_post = asyncHandler(async (req, res, next) => {
